...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen max-h-screen relative flex items-center justify-center">
      {/* Background Image */}
      ...
      {/* Login Card */}
      <Card className="relative z-10 w-full max-w-md bg-black/95 border-black">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold text-white">Welcome to Niko's Schedule</CardTitle>
          <p className="text-gray-400 mt-2">Choose how you'd like to continue</p>
        </CardHeader>
